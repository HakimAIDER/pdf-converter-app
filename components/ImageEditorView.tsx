    ...
    const handleAiAction = async () => {
        ...
        try {
            ...
            if (imagePart?.inlineData) {
                ...
                throw new Error("L'API n'a pas retourné d'image. Cela peut être dû aux politiques de sécurité (par ex. l'image contient des visages) ou à un échec du modèle à effectuer la tâche demandée.");
            }
        } catch (e: any) {
