...
export const ImageRemoveBgView: React.FC = () => {
    ...
    const handleRemoveBackground = async () => {
        ...
        try {
            ...
            const prompt = "Critically important: Remove the background from this image. The output image must have a transparent background. The subject should be perfectly and cleanly isolated. The output format should be a PNG to preserve transparency.";
            ...
            if (imagePart?.inlineData) {
                ...
                throw new Error("L'API n'a pas retourné d'image. Le contenu a peut-être été bloqué, l'arrière-plan n'a pas été détecté, ou la réponse est dans un format inattendu.");
            }
