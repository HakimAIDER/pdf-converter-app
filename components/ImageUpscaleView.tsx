...
export const ImageUpscaleView: React.FC = () => {
    ...
    const handleUpscale = async () => {
        ...
        try {
            ...
            const prompt = `Upscale this image. Increase its resolution by a factor of ${scaleFactor}. For example, if the original image is 500x500 pixels, a ${scaleFactor}x upscale should result in a ${500*scaleFactor}x${500*scaleFactor} pixel image. Preserve all original details and art style. Do not add, remove, or change any elements in the image. The output image dimensions must be exactly ${scaleFactor} times the original dimensions.`;
