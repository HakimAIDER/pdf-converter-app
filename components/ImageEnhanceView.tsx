...
import { UploadIcon, DownloadIcon, QualityIcon } from './IconComponents';
...
export const ImageEnhanceView: React.FC = () => {
    ...
    const handleEnhance = async () => {
        ...
        try {
            ...
            const prompt = "Améliorez considérablement la qualité de cette image. Augmentez la clarté, réduisez le bruit et les artefacts, corrigez les couleurs et l'éclairage, et accentuez les détails pour un rendu professionnel. Ne modifiez pas la composition, le contenu, l'aspect ratio ou la résolution de l'image. Le résultat doit être une version bien meilleure de l'image originale.";
    ...
    return (
        <div className="bg-slate-800/50 backdrop-blur-xl border border-slate-700/50 rounded-2xl p-6 sm:p-8 shadow-2xl">
            <h2 className="text-2xl font-semibold mb-4 text-center text-slate-100 flex items-center justify-center gap-3">
                <QualityIcon className="w-7 h-7" />
                Améliorer la Qualité (IA)
            </h2>
            <p className="text-center text-slate-400 mb-6">Améliorez automatiquement la clarté, les couleurs et les détails de votre image.</p>
                ...
                <div className="flex flex-col space-y-6">
                    ...
                    {imageFile && (
                       <button
                        ...
                        >
                            {isProcessing ? <><Spinner /> Amélioration en cours...</> : "Améliorer la Qualité"}
                        </button>
                    )}
                </div>
                ...
                <div className="flex flex-col items-center justify-center bg-slate-900/50 border border-slate-700 rounded-lg p-4 min-h-[300px] lg:min-h-full">
                    {isProcessing && (
                        <div className="text-center">
                           ...
                           <p className="mt-2 text-slate-300">L'IA sublime votre image...</p>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 w-full">
                                ...
                                <div className="space-y-2">
                                    <h4 className="text-center font-semibold text-slate-300">Après</h4>
                                     <div className="aspect-square bg-black/20 rounded-lg flex items-center justify-center p-1">
                                      <img src={processedImageUrl} alt="Améliorée" className="max-w-full max-h-full rounded-md object-contain"/>
                                    </div>
                                </div>
                            </div>
                    ...
                    {!isProcessing && !processedImageUrl && (
                        <div className="text-center text-slate-400 p-4">
                           <QualityIcon className="w-16 h-16 mx-auto text-slate-500"/>
