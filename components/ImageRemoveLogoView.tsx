...
export const ImageRemoveLogoView: React.FC = () => {
    ...
    const handleRemoveLogo = async () => {
        ...
        try {
            ...
            const prompt = "Supprime tous les logos ou filigranes de cette image. Remplis la zone où se trouvait le logo ou le filigrane pour qu'elle se fonde de manière réaliste et transparente avec l'arrière-plan.";
